...
/**
    \brief Функция для вывода истории запросов
    Выводит последние STORY_SIZE (5 по умолчанию) запросов.
    На вход принимает количество уравнений, которые нужно вывести, массив из которого нужно читать уравнения и специальный флаг для корректного вывода.
    Подробнее о флаге в описании к функции SetFlag().
*/
...
/** 
            Функция SetFlag() используется для реализации вывода истории запросов в порядке очереди.
