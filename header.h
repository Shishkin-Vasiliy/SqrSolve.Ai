...
/// коды ошибок в тестах
enum NUM_CODE {
	PASS = -1,       ///< Указывает, что тест пройден успешно
	CODE_ZERO = 0,   ///< Указывает, что ошибка в вычислении дискриминанта
	CODE_ONE = 1,    ///< Указывает, что ошибка в вычислении количества корней
	CODE_TWO = 2,    ///< Указывает, что ошибка в вычислении единственного корня
	CODE_THREE = 3,  ///< Указывает, что ошибка в вычислении двух вещественных корней
	CODE_FOUR = 4	 ///< Указывает, что ошибка в вычислении двух комплексных корней
};
